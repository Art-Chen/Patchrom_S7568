...
.method public constructor <init>(Landroid/webkit/WebView$InvokeListBox;)V
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$13900(Landroid/webkit/WebView;)Landroid/content/Context;

    move-result-object v1

    #getter for: Landroid/webkit/WebView$InvokeListBox;->mMultiple:Z
    invoke-static {p1}, Landroid/webkit/WebView$InvokeListBox;->access$14000(Landroid/webkit/WebView$InvokeListBox;)Z
    ...
    invoke-static {p1}, Landroid/webkit/WebView$InvokeListBox;->access$14100(Landroid/webkit/WebView$InvokeListBox;)[Landroid/webkit/WebView$InvokeListBox$Container;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v4}, Landroid/webkit/WebView$InvokeListBox;->access$14200(Landroid/webkit/WebView$InvokeListBox;)Z
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v4}, Landroid/webkit/WebView;->access$14300(Landroid/webkit/WebView;)Landroid/content/Context;
