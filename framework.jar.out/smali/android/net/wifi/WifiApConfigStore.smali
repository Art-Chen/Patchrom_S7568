...
.method private parseCustFeaturePassword(Z)Ljava/lang/String;
    .locals 11
    .parameter "retry"
    ...
    invoke-direct {p0, v6, v7, v8}, Landroid/net/wifi/WifiApConfigStore;->getRandomAlphabet(IJ)Ljava/lang/String;
...
.method private parseCustFeatureSSID(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 273
    .local v2, custDefaultSSID:Ljava/lang/String;
    const-string v9, ","
    ...
    .line 274
    .local v3, customSSID:[Ljava/lang/String;
    const/4 v4, 0x0
...
.method private reGenerateAndWriteConfiguration()V
    ...
    invoke-direct {p0, v2}, Landroid/net/wifi/WifiApConfigStore;->parseCustFeaturePassword(Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v6, v7}, Landroid/net/wifi/WifiApConfigStore;->getRandomAlphabet(IJ)Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v6, v7}, Landroid/net/wifi/WifiApConfigStore;->getRandomDigits(IJ)Ljava/lang/String;
...
.method private setDefaultApConfiguration()V
    ...
    .line 247
    :cond_1
    invoke-direct {p0, v4}, Landroid/net/wifi/WifiApConfigStore;->parseCustFeaturePassword(Z)Ljava/lang/String;
