...
.method static synthetic access$1000(Lcom/android/server/wm/WindowManagerService;Ljava/lang/String;)Landroid/content/ComponentName;
    .locals 1
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/wm/WindowManagerService;->convertActivityResultToComponentName(Ljava/lang/String;)Landroid/content/ComponentName;
...
.method private final performLayoutAndPlaceSurfacesLocked()V
    ...
    invoke-static {v7, v8, v1}, Landroid/util/safelog/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private final performLayoutAndPlaceSurfacesLockedInner(Z)V
    ...
    .local v83, orientationChangeComplete:Z
    const/16 v61, 0x0

    .local v61, holdScreen:Lcom/android/server/wm/Session;
    const/high16 v87, -0x4080

    .local v87, screenBrightness:F
    const/high16 v37, -0x4080

    .local v37, buttonBrightness:F
    const/16 v55, 0x0

    .local v55, focusDisplayed:Z
    const/16 v30, 0x0

    .local v30, animating:Z
    const/16 v45, 0x0

    .local v45, createWatermark:Z
    const/16 v97, 0x0

    .local v97, updateRotation:Z
    const/16 v88, 0x0

    .local v88, screenRotationFinished:Z
    move-object/from16 v0, p0
    ...
    .local v100, wallpaperForceHidingChanged:Z
    const/16 v86, 0x0
    ...
    .local v89, someoneLosingFocus:Z
    :goto_4
    const/16 v79, 0x0

    .local v79, obscured:Z
    const/16 v36, 0x0

    .local v36, blurring:Z
    const/16 v50, 0x0
    ...
    .local v98, w:Lcom/android/server/wm/WindowState;
    const/16 v51, 0x0
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->computeShownFrameLocked()V
    ...
    .end local v90           #surfaceResized:Z
    .end local v103           #width:I
    :cond_10
    :goto_9
    :try_start_3
    move-object/from16 v0, v98
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isReadyForDisplay()Z
    ...
    :cond_1c
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isDisplayedLw()Z

    move-result v38

    .local v38, canBeSeen:Z
    if-eqz v89, :cond_1d
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isOpaqueDrawn()Z
    ...
    .end local v36           #blurring:Z
    .end local v38           #canBeSeen:Z
    .end local v44           #covered:Z
    .end local v50           #dimming:Z
    .end local v51           #displayed:Z
    .end local v79           #obscured:Z
    .end local v80           #obscuredChanged:Z
    .end local v89           #someoneLosingFocus:Z
    .end local v91           #syswin:Z
    .end local v98           #w:Lcom/android/server/wm/WindowState;
    :cond_25
    and-int/lit8 v5, v40, 0x7
    ...
    .local v96, transactionSequence:I
    const/16 v95, 0x0

    .local v95, tokensAnimating:Z
    move-object/from16 v0, p0
    ...
    .local v94, tokenMayBeDrawn:Z
    const/16 v101, 0x0

    .local v101, wallpaperMayChange:Z
    const/16 v56, 0x0

    .local v56, forceHiding:Z
    const/16 v108, 0x0

    .local v108, windowDetachedWallpaper:Lcom/android/server/wm/WindowState;
    const/16 v106, 0x0

    .local v106, windowAnimationBackground:Lcom/android/server/wm/WindowState;
    const/16 v107, 0x0

    .local v107, windowAnimationBackgroundColor:I
    const/16 v68, 0x0

    .local v68, keyguard:Lcom/android/server/wm/WindowState;
    move-object/from16 v0, p0
    ...
    .restart local v98       #w:Lcom/android/server/wm/WindowState;
    move-object/from16 v0, v98
    ...
    .local v28, animDh:I
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->shouldAnimateMove()Z
    ...
    .local v26, a:Landroid/view/animation/Animation;
    move-object/from16 v0, v98
    ...
    .local v84, packageName:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .local v42, componentName:Landroid/content/ComponentName;
    const-string v5, "WindowManager"
    ...
    .local v71, mwm:Lcom/android/server/sec/MultiWindowManagerService;
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->clearAnimation()V
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_6} :catch_0
    .catch Ljava/lang/RuntimeException; {:try_start_6 .. :try_end_6} :catch_1

    .end local v26           #a:Landroid/view/animation/Animation;
    .end local v34           #bFind:Z
    .end local v41           #className:Ljava/lang/String;
    .end local v42           #componentName:Landroid/content/ComponentName;
    .end local v71           #mwm:Lcom/android/server/sec/MultiWindowManagerService;
    .end local v84           #packageName:Ljava/lang/String;
    :cond_34
    :goto_1b
    :try_start_7
    move-object/from16 v0, v98
    ...
    .end local v28           #animDh:I
    .end local v29           #animDw:I
    .end local v65           #isAttachedWindowToKeyguard:Z
    .end local v76           #nowAnimating:Z
    .end local v102           #wasAnimating:Z
    :cond_3e
    move-object/from16 v0, v98
    ...
    :cond_40
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isOnScreen()Z
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isDrawnLw()Z
    ...
    .end local v68           #keyguard:Lcom/android/server/wm/WindowState;
    .end local v94           #tokenMayBeDrawn:Z
    .end local v98           #w:Lcom/android/server/wm/WindowState;
    .end local v101           #wallpaperMayChange:Z
    .end local v106           #windowAnimationBackground:Lcom/android/server/wm/WindowState;
    .end local v107           #windowAnimationBackgroundColor:I
    .end local v108           #windowDetachedWallpaper:Lcom/android/server/wm/WindowState;
    :cond_44
    const/16 v88, 0x1
    ...
    .restart local v20       #N:I
    .restart local v26       #a:Landroid/view/animation/Animation;
    .restart local v28       #animDh:I
    .restart local v29       #animDw:I
    .restart local v33       #attrs:Landroid/view/WindowManager$LayoutParams;
    .restart local v34       #bFind:Z
    .restart local v56       #forceHiding:Z
    .restart local v68       #keyguard:Lcom/android/server/wm/WindowState;
    .restart local v94       #tokenMayBeDrawn:Z
    .restart local v98       #w:Lcom/android/server/wm/WindowState;
    .restart local v101       #wallpaperMayChange:Z
    .restart local v102       #wasAnimating:Z
    .restart local v106       #windowAnimationBackground:Lcom/android/server/wm/WindowState;
    .restart local v107       #windowAnimationBackgroundColor:I
    .restart local v108       #windowDetachedWallpaper:Lcom/android/server/wm/WindowState;
    :catch_0
    move-exception v54
    ...
    .end local v68           #keyguard:Lcom/android/server/wm/WindowState;
    .end local v94           #tokenMayBeDrawn:Z
    .end local v95           #tokensAnimating:Z
    .end local v96           #transactionSequence:I
    .end local v98           #w:Lcom/android/server/wm/WindowState;
    .end local v101           #wallpaperMayChange:Z
    .end local v102           #wasAnimating:Z
    .end local v106           #windowAnimationBackground:Lcom/android/server/wm/WindowState;
    ...
    invoke-interface {v5}, Landroid/view/WindowManagerPolicy;->isKeyguardReady()Z
    ...
    check-cast v104, Lcom/android/server/wm/WindowState;

    .local v104, win:Lcom/android/server/wm/WindowState;
    const/16 v49, 0x0
    ...
    .restart local v43       #configChanged:Z
    :goto_20
    move-object/from16 v0, p0
    ...
    .end local v104           #win:Lcom/android/server/wm/WindowState;
    :cond_4b
    const/16 v99, 0x0

    .local v99, wallpaperDestroyed:Z
    move-object/from16 v0, p0
    ...
    .restart local v104       #win:Lcom/android/server/wm/WindowState;
    const/4 v5, 0x0
    ...
    :cond_4e
    invoke-virtual/range {v104 .. v104}, Lcom/android/server/wm/WindowState;->destroySurfaceLocked()V
    ...
    check-cast v93, Lcom/android/server/wm/WindowToken;

    .local v93, token:Lcom/android/server/wm/WindowToken;
    ...
    .end local v93           #token:Lcom/android/server/wm/WindowToken;
    .end local v99           #wallpaperDestroyed:Z
    .restart local v20       #N:I
    .restart local v21       #NAT:I
    .restart local v23       #NEAT:I
    .restart local v28       #animDh:I
    .restart local v29       #animDw:I
    .restart local v33       #attrs:Landroid/view/WindowManager$LayoutParams;
    .restart local v56       #forceHiding:Z
    .restart local v68       #keyguard:Lcom/android/server/wm/WindowState;
    .restart local v76       #nowAnimating:Z
    .restart local v94       #tokenMayBeDrawn:Z
    .restart local v95       #tokensAnimating:Z
    .restart local v96       #transactionSequence:I
    .restart local v98       #w:Lcom/android/server/wm/WindowState;
    .restart local v101       #wallpaperMayChange:Z
    .restart local v102       #wasAnimating:Z
    .restart local v106       #windowAnimationBackground:Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isAllDrawn()Z
    ...
    .restart local v39       #changed:Z
    if-eqz v39, :cond_56

    if-eqz v100, :cond_58

    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isVisibleNow()Z
    ...
    .end local v77           #numInteresting:I
    :cond_5d
    :goto_26
    add-int/lit8 v62, v62, 0x1
    ...
    .restart local v77       #numInteresting:I
    if-lez v77, :cond_5d
    ...
    .local v81, oldWallpaper:Lcom/android/server/wm/WindowState;
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/WindowManagerService;->adjustWallpaperWindowsLocked()I
    ...
    .local v109, ws:Lcom/android/server/wm/WindowState;
    if-eqz v109, :cond_68
    ...
    .end local v109           #ws:Lcom/android/server/wm/WindowState;
    :cond_68
    :goto_2b
    add-int/lit8 v62, v62, 0x1
    ...
    .restart local v109       #ws:Lcom/android/server/wm/WindowState;
    if-eqz v109, :cond_68
    ...
    .end local v22           #NC:I
    .end local v24           #NN:I
    .end local v35           #bestAnimLayer:I
    .end local v57           #foundWallpapers:I
    .end local v58           #fullscreenAnim:Z
    .end local v59           #goodToGo:Z
    .end local v81           #oldWallpaper:Lcom/android/server/wm/WindowState;
    :cond_73
    const/16 v27, 0x0

    .local v27, adjResult:I
    if-nez v30, :cond_74
    ...
    .restart local v81       #oldWallpaper:Lcom/android/server/wm/WindowState;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v98 .. v98}, Lcom/android/server/wm/WindowState;->isVisibleLw()Z
    ...
    .local v92, target:Lcom/android/server/wm/WindowState;
    const/16 v19, 0x0

    .local v19, DEBUG_MW_ANIMATION:Z
    if-eqz v19, :cond_7a
    ...
    const-string v10, "origin target="
    ...
    .local v73, needsWindowAnimationBackground:Z
    if-eqz v106, :cond_7c
    ...
    iget v5, v5, Landroid/view/WindowManager$LayoutParams;->windowMode:I
    ...
    const-string v8, "split app is chosen for windowAnimationBackground. we need to adjust DimSurface\'s layer"
    ...
    .local v105, windowAnimBackgroundIndex:I
    move-object/from16 v0, p0
    ...
    .local v74, nextSplitWindow:Lcom/android/server/wm/WindowState;
    const/16 v75, -0x1

    .local v75, nextSplitWindowIndex:I
    add-int/lit8 v66, v105, -0x1
    ...
    const-string v10, " mAttachedWindow="
    ...
    iget v10, v10, Landroid/view/WindowManager$LayoutParams;->windowMode:I
    ...
    const-string v10, "next split : w.mAttachedWindow="
    ...
    const-string v10, " windowMode=WINDOW_MODE_SPLIT"
    ...
    const-string v10, "nextSplitWindow="
    ...
    const-string v10, "found lowest child window. target="
    ...
    .end local v66           #j:I
    .end local v73           #needsWindowAnimationBackground:Z
    .end local v74           #nextSplitWindow:Lcom/android/server/wm/WindowState;
    .end local v75           #nextSplitWindowIndex:I
    .end local v105           #windowAnimBackgroundIndex:I
    :cond_87
    if-eqz v19, :cond_88
    ...
    const-string v10, "selected target="
    ...
    const-string v10, "finally selected target="
    ...
    .end local v19           #DEBUG_MW_ANIMATION:Z
    .end local v92           #target:Lcom/android/server/wm/WindowState;
    :cond_8c
    :goto_35
    if-eqz v101, :cond_8d
    ...
    .restart local v19       #DEBUG_MW_ANIMATION:Z
    .restart local v66       #j:I
    .restart local v73       #needsWindowAnimationBackground:Z
    .restart local v74       #nextSplitWindow:Lcom/android/server/wm/WindowState;
    .restart local v75       #nextSplitWindowIndex:I
    .restart local v92       #target:Lcom/android/server/wm/WindowState;
    .restart local v105       #windowAnimBackgroundIndex:I
    :cond_90
    add-int/lit8 v66, v105, -0x1
    ...
    check-cast v78, Lcom/android/server/wm/WindowState;

    .local v78, nw:Lcom/android/server/wm/WindowState;
    ...
    .end local v67           #k:I
    .end local v78           #nw:Lcom/android/server/wm/WindowState;
    :cond_92
    add-int/lit8 v66, v66, -0x1
    ...
    .restart local v33       #attrs:Landroid/view/WindowManager$LayoutParams;
    .restart local v36       #blurring:Z
    .restart local v44       #covered:Z
    .restart local v50       #dimming:Z
    .restart local v51       #displayed:Z
    .restart local v52       #doNotResizeWallpaperWindow:Z
    .restart local v79       #obscured:Z
    .restart local v89       #someoneLosingFocus:Z
    .restart local v91       #syswin:Z
    .restart local v98       #w:Lcom/android/server/wm/WindowState;
    :cond_97
    move-object/from16 v0, v98
    ...
    .restart local v90       #surfaceResized:Z
    :catch_2
    move-exception v54
    ...
    .restart local v38       #canBeSeen:Z
    :cond_a5
    const/16 v80, 0x0

    goto/16 :goto_12

    .restart local v80       #obscuredChanged:Z
    :cond_a6
    const/16 v82, 0x0

    goto/16 :goto_13

    .restart local v82       #opaqueDrawn:Z
    :cond_a7
    if-eqz v38, :cond_23
    ...
    .end local v104           #win:Lcom/android/server/wm/WindowState;
    .restart local v99       #wallpaperDestroyed:Z
    :cond_b3
    move-object/from16 v0, p0
    ...
    check-cast v93, Lcom/android/server/wm/AppWindowToken;

    .local v93, token:Lcom/android/server/wm/AppWindowToken;
    move-object/from16 v0, v93
    ...
    .end local v93           #token:Lcom/android/server/wm/AppWindowToken;
    :cond_b5
    const/16 v72, 0x0
...
.method private final performLayoutLockedInner(ZZ)I
    ...
    .prologue
    iget-boolean v11, p0, Lcom/android/server/wm/WindowManagerService;->mLayoutNeeded:Z
    ...
    .local v3, dh:I
    iget-object v11, p0, Lcom/android/server/wm/WindowManagerService;->mFakeWindows:Ljava/util/ArrayList;
    ...
    check-cast v11, Lcom/android/server/wm/FakeWindowImpl;

    invoke-virtual {v11, v4, v3}, Lcom/android/server/wm/FakeWindowImpl;->layout(II)V
    ...
    invoke-interface {v11, v4, v3, v12}, Landroid/view/WindowManagerPolicy;->beginLayoutLw(III)V

    iget v11, p0, Lcom/android/server/wm/WindowManagerService;->mLayoutSeq:I
    ...
    .local v2, bNotifySip:Z
    const/4 v9, -0x1

    .local v9, topAttached:I
    ...
    iget-boolean v11, v10, Lcom/android/server/wm/WindowState;->mHaveFrame:Z

    if-eqz v11, :cond_3

    iget-boolean v11, v10, Lcom/android/server/wm/WindowState;->mLayoutNeeded:Z

    if-eqz v11, :cond_6

    :cond_3
    iget-boolean v11, v10, Lcom/android/server/wm/WindowState;->mLayoutAttached:Z
    ...
    iput-boolean v11, v10, Lcom/android/server/wm/WindowState;->mLayoutNeeded:Z

    invoke-virtual {v10}, Lcom/android/server/wm/WindowState;->prelayout()V
    ...
    invoke-interface {v11, v10, v12, v13}, Landroid/view/WindowManagerPolicy;->layoutWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;)V

    iput v8, v10, Lcom/android/server/wm/WindowState;->mLayoutSeq:I
    ...
    :cond_5
    invoke-virtual {v10}, Lcom/android/server/wm/WindowState;->getGivenInsetsPendingLw()Z
    ...
    iget-boolean v11, v10, Lcom/android/server/wm/WindowState;->mRelayoutCalled:Z
    ...
    .local v7, sService:Lcom/android/server/sec/MultiWindowManagerService;
    const/4 v11, 0x0

    invoke-virtual {v7, v11}, Lcom/android/server/sec/MultiWindowManagerService;->notifySIP(I)Z

    .end local v7           #sService:Lcom/android/server/sec/MultiWindowManagerService;
    :cond_f
    ...
    invoke-interface {v11}, Landroid/view/WindowManagerPolicy;->finishLayoutLw()I
...
.method public addWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;ILandroid/graphics/Rect;Landroid/view/InputChannel;)I
    ...
    iget-object v3, v3, Lcom/android/server/wm/WindowToken;->windows:Ljava/util/ArrayList;
...
.method findDesiredInputMethodWindowIndexLocked(Z)I
    ...
    invoke-virtual {p0, v8, v12}, Lcom/android/server/wm/WindowManagerService;->countWindowsBetweenTargetAndWidget(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)I
...
.method public getMainWindowAttrs(Landroid/view/IApplicationToken;)Landroid/view/WindowManager$LayoutParams;
    .locals 8
    .parameter "token"
...
.method final isWallpaperVisible(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {v6}, Landroid/sec/multiwindow/MultiWindowType;->getiValue()I
    ...
    iget-object v4, v6, Landroid/view/WindowManager$LayoutParams;->packageName:Ljava/lang/String;
    ...
    iget-object v6, v6, Lcom/android/server/wm/AppWindowToken;->animation:Landroid/view/animation/Animation;

    if-nez v6, :cond_4

    :cond_3
    iget-object v6, p0, Lcom/android/server/wm/WindowManagerService;->mUpperWallpaperTarget:Lcom/android/server/wm/WindowState;
...
.method public reloadPointerIcon(III)V
    .locals 3
    ...
    invoke-static {p2, p3}, Landroid/view/PointerIcon;->setPointerIcon(II)V

    iget-object v0, p0, Lcom/android/server/wm/WindowManagerService;->mInputManager:Lcom/android/server/wm/InputManager;

    invoke-virtual {v0, p1}, Lcom/android/server/wm/InputManager;->reloadPointerIcon(I)V

    return-void
.end method

.method public reloadPointerIconForBitmap(IILandroid/graphics/Bitmap;)I
    .locals 4
    .parameter "pointerType"
    .parameter "iconType"
    .parameter "bitmap"
    ...
    invoke-static {p2, v0}, Landroid/view/PointerIcon;->setPointerIcon(II)V

    iget-object v1, p0, Lcom/android/server/wm/WindowManagerService;->mInputManager:Lcom/android/server/wm/InputManager;

    invoke-virtual {v1, p1}, Lcom/android/server/wm/InputManager;->reloadPointerIcon(I)V
...
.method public setSafetyZone(ZIIII)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/server/wm/InputManager;->setSafetyZone(ZIIII)Z
...
.method public setStatusBarCanHide(Landroid/content/ComponentName;Z)Z
    ...
    invoke-interface {v3, p1, p2}, Landroid/view/WindowManagerPolicy;->setStatusBarCanHide(Landroid/content/ComponentName;Z)Z
