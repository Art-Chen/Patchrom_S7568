...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/media/AudioService$UsbAudioData;
    }
.end annotation
...
.field private mExternalUsbInfo:Landroid/media/AudioService$UsbAudioData;
...
.field private ringtoneChecker:Landroid/media/RingtoneChecker;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Landroid/media/AudioService;->mProductname:Ljava/lang/String;
    ...
    new-instance v3, Landroid/media/AudioService$UsbAudioData;

    invoke-direct {v3, p0, v8}, Landroid/media/AudioService$UsbAudioData;-><init>(Landroid/media/AudioService;Landroid/media/AudioService$1;)V

    iput-object v3, p0, Landroid/media/AudioService;->mExternalUsbInfo:Landroid/media/AudioService$UsbAudioData;
    ...
    const-string v3, "android.intent.action.EXTERNAL_USB_HEADSET_INFO"
    ...
    new-instance v3, Landroid/media/RingtoneChecker;

    iget-object v4, p0, Landroid/media/AudioService;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Landroid/media/RingtoneChecker;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Landroid/media/AudioService;->ringtoneChecker:Landroid/media/RingtoneChecker;
...
.method static synthetic access$6900(Landroid/media/AudioService;)Landroid/bluetooth/BluetoothProfile$ServiceListener;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7000(Landroid/media/AudioService;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7100(Landroid/media/AudioService;)Landroid/media/AudioService$UsbAudioData;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Landroid/media/AudioService;->mExternalUsbInfo:Landroid/media/AudioService$UsbAudioData;
...
.method static synthetic access$7800(Landroid/media/AudioService;IIII)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$8200(Landroid/media/AudioService;Landroid/os/IBinder;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private readPersistedSettings()V
    ...
    const-string v2, "Remove STREAM_SYSTEM_ENFORCED"
...
.method public abandonAudioFocus(Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;)I
    ...
    const-string v2, " AudioFocus  abandonAudioFocus() "
...
.method public adjustStreamVolume(III)V
    ...
    iget v8, v0, Landroid/media/AudioService;->mAllSoundMute:I
    ...
    const-string v8, "MSG_SET_SYSTEM_VOLUME: streamAlias "
...
.method public requestAudioFocus(IILandroid/os/IBinder;Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v2, " AudioFocus  requestAudioFocus()  "

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v1, p0, Landroid/media/AudioService;->mProductname:Ljava/lang/String;

    const-string v2, "p4noterf"
    ...
    const-string v3, " AudioFocus  requestAudioFocus() packageName "
...
.method public setMediaSilentMode(Z)V
    ...
    const-string v4, "setMediaSilentMode "
    ...
    const-string v4, "setMediaSilentMode musicLev"
