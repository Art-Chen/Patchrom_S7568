...
.method private buildWaitingApns(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    const-string v7, "isOrangeWorldActive:"
...
.method private setCarrierEnabledField(Ljava/lang/String;Z)Z
    ...
    const-string v7, "setCarrierEnabledField: update database success apn = "
    ...
    const-string v7, "setCarrierEnabledField: update database failed apn = "
...
.method private setupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    const-string v10, "setupData: apn="
    ...
    const-string v10, "setupData: DataConnection for type "
    ...
    const-string v7, "setupData: change waiting apns and current apn as found dcac"
    ...
    :cond_b
    const-string v7, "setupData: don\'t change waiting apn in dc because it\'s null"
...
.method public doAutoRoamingApnChange(Ljava/lang/String;Z)Z
    ...
    const-string v5, "wroaming.lguplus.co.kr"
    ...
    :cond_3
    const-string v5, "tethering.lguplus.co.kr"
    ...
    :cond_8
    const-string v3, "tethering.lguplus.co.kr"
