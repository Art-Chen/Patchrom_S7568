...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "mOnPreparedListener. Send MEDIA_PREPARED message."
    ...
    const-string v3, "mOnPreparedListener is null. Failed to send MEDIA_PREPARED message."
    ...
    const-string v3, "mOnCompletionListener. Send MEDIA_PLAYBACK_COMPLETE message."
    ...
    const-string v3, "mOnCompletionListener is null. Failed to send MEDIA_PLAYBACK_COMPLETE message."
    ...
    const-string v3, "mOnBufferingUpdateListener is null. Failed to send MEDIA_BUFFERING_UPDATE message."
    ...
    const-string v3, "mOnSeekCompleteListener. Send MEDIA_SEEK_COMPLETE message."
    ...
    const-string v3, "mOnSeekCompleteListener is null. Failed to send MEDIA_SEEK_COMPLETE message."
    ...
    const-string v3, "mOnVideoSizeChangedListener. Send MEDIA_SET_VIDEO_SIZE message."
    ...
    const-string v3, "mOnVideoSizeChangedListener is null. Failed to send MEDIA_SET_VIDEO_SIZE message."
    ...
    const-string v3, "mOnErrorListener is null. Failed to send MEDIA_ERROR message."
    ...
    const-string v3, "mOnInfoListener. Send MEDIA_INFO message."
    ...
    const-string v3, "mOnInfoListener is null. Failed to send MEDIA_INFO message."
    ...
    const-string v3, "mOnTimedTextListener is null. Failed to send MEDIA_TIMED_TEXT message."
