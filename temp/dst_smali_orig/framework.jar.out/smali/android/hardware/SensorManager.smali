...
.method static native acc_factory_test(I[I)I
.end method
...
.method private unregisterListener(Ljava/lang/Object;)V
    ...
    const-string v7, "unregisterListener:: disable all sensors for this listener,  listener = "
...
.method public registerListener(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;I)Z
    ...
    const-string v9, "rate must be >=0"
...
.method public runAccFactoryTest(I[I)I
    .locals 2
    .parameter "testno"
    .parameter "result"
    ...
    const-string v1, "Acc sensor FactoryTest"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {p1, p2}, Landroid/hardware/SensorManager;->acc_factory_test(I[I)I
