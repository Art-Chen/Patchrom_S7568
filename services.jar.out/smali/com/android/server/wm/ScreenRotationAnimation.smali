...
.method public dismiss(Landroid/view/SurfaceSession;JFII)Z
    ...
    .line 231
    iput-boolean v5, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mStarted:Z
    ...
    new-instance v5, Lcom/android/server/wm/BlackFrame;

    const v6, 0x1e8480

    invoke-direct {v5, p1, v4, v2, v6}, Lcom/android/server/wm/BlackFrame;-><init>(Landroid/view/SurfaceSession;Landroid/graphics/Rect;Landroid/graphics/Rect;I)V

    iput-object v5, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mBlackFrame:Lcom/android/server/wm/BlackFrame;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v5, v6, v1}, Landroid/util/safelog/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
